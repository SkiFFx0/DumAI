<div class="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-12 animate-fade-in">
    <div class="w-full max-w-md bg-gray-800 rounded-xl shadow-2xl p-8 space-y-6 border border-gray-700">
        ...
        <h2 class="text-3xl font-bold text-center text-purple-400">Welcome Back</h2>
        <p class="text-center text-gray-400">Continue your conversation with DumAI</p>
        ...
        <form wire:submit="login" class="space-y-6">
            ...
            @error('submit') <span class="text-red-400 text-sm block text-center">{{ $message }}</span> @enderror
        </form>
